...
class MapView extends Component {
  ...
  onAllFilterChanged = names => {
    const filters = names.reduce(
      (obj, name) => Object.assign(obj, { [name]: true }),
      {}
    );
    this.setState({ filters });
  };
    ...
    return (
      <div className="MapView">
        ...
        <MapFilters
          ...
          onAllFilterChanged={this.onAllFilterChanged}
        />
        <SignModal
